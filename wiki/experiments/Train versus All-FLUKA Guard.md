...
Each physical feature is mapped to its configured stable space. Bounds are the wider side of the weighted 3×IQR fence and weighted q0.0001/q0.9999 limits. Raw minimum and maximum are not used. FLUKA `w` is used only to estimate the target-density quantiles; it is not guarded as a generated feature.
